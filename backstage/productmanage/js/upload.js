(function( $ ){
    ...
    $(function() {
        ...
        uploader = WebUploader.create({
            ...
            chunked: false,
            chunkSize: 512 * 1024,
            server: 'http://localhost:8080/xxmall/backstage/adminManage/testFile2',
            // runtimeOrder: 'flash',
            // accept: {
            //     title: 'Images',
        ...
        $upload.on('click', function() {
            ...
            // }else{
            //     alert($('.webuploader-element-invisible').size());
            //     var files = $('.webuploader-element-invisible').eq(0).prop('files');
            //     alert(files[0]);
            //     if(files.length == 0){
            //         alert('请选择文件');
            //         return;
